...
namespace TripEventPlanner.Controllers
{
    public class ActivityTypesController : Controller
    {
        ...
        public ActivityTypesController(ItravelPlannerDBContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(short id, [Bind("ActivityTypeId,Name")] ActivityType activityType)
        {
        ...
        private bool ActivityTypeExists(short id)
        {
